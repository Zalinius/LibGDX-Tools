...
public class PixelCursor extends Image implements DoesNotPause {
	...
	public PixelCursor(WindowResizer windowResizer) {
		super(Assets.get(Assets.pixelCursor));
	...
	public void act(float delta) {
		...
		if (x == 0 && y == 0 && windowResizer.isWindowed()) {
			...
			// TODO if ever we figure out detecting that the cursor is off-screen then this won't be necessary, but last time I looked into that
