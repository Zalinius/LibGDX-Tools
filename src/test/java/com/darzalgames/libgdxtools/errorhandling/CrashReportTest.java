...
class CrashReportTest {
	...
	void getters() throws Exception {
		...
		CrashReport crashReport = new CrashReport("gameName", "version", "platformName", instant, uuid, "stackTrace");
		...
		assertEquals("stackTrace", crashReport.getStackTrace());
	}
	...
	void toJson() throws Exception {
		Instant instant = Instant.parse("2025-02-09T18:40:36.949177809Z");
		UUID uuid = UUID.fromString("8c6b106b-e613-4cdd-b75b-2b6592c6806d");
		CrashReport crashReport = new CrashReport("game", "version", "platform", instant, uuid, "java.lang.RuntimeException");
