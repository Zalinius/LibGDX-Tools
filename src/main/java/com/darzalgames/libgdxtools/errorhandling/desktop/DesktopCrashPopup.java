...
public class DesktopCrashPopup extends JFrame {
	...
	public DesktopCrashPopup(CrashReport crashReport, Supplier<ReportStatus> sendErrorReport, String localCrashReportFile, CrashLocalization crashLocalization) {
		...
		JScrollPane crashReportScrollPane = new JScrollPane(crashReportArea, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
		...
		buttonSendReport = new JButton(crashLocalization.getSendButtonString());
	...
	private static class SingleUseThreadedAction implements ActionListener{
		...
		public SingleUseThreadedAction(Runnable runnable) {
			notRun = new AtomicBoolean(true);
			singleUseRunnable = runnable;
		}
	...
	private JLabel makeLabel(String text) {
		JLabel jLabel = new JLabel(text, SwingConstants.LEFT);
