...
public class GameBoyPallet {
	...
	public static final Color DARKEST_GREEN = makeColorFromIntComponents(15, 56, 15); 
	public static final Color DARK_GREEN = makeColorFromIntComponents(48, 98, 48); 
	public static final Color LIGHT_GREEN = makeColorFromIntComponents(139, 172, 15); 
	public static final Color LIGHTEST_GREEN = makeColorFromIntComponents(155, 188, 15); 	
	 ...
	 */
	public static Color makeColorFromIntComponents(int red, int green, int blue) {
	...
	private static boolean componentsInvalid(int red, int green, int blue) {
	...
	private static int componentsToRGBAIntegerBits(int red, int green, int blue) {
