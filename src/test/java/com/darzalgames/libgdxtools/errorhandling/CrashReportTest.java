...
class CrashReportTest {
	...
	void getters() {
		...
		CrashReport crashReport = new CrashReport("gameName", "version", "operatingSystem", instant, uuid, new String[] { "stackTrace" });

		assertEquals("gameName", crashReport.getGameName());
		assertEquals("version", crashReport.getGameVersion());
		assertEquals("operatingSystem", crashReport.getOperatingSystemName());
	...
	void toJson() {
		Instant instant = Instant.parse("2025-02-09T18:40:36.949177809Z");
		UUID uuid = UUID.fromString("8c6b106b-e613-4cdd-b75b-2b6592c6806d");
		CrashReport crashReport = new CrashReport("game", "version", "operatingSystem", instant, uuid, new String[] { "java.lang.RuntimeException", "caused by:" });
