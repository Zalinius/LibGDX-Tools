...
public class InputSetup {
	...
	public InputSetup(InputStrategySwitcher inputStrategySwitcher, OptionsMenu pauseMenu, Runnable toggleFullscreenRunnable, boolean toggleWithF11, Stage popUpStage) {
